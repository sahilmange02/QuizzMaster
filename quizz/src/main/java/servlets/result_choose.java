 ...
 */
public class result_choose extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public result_choose() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<div class=\"container\" style=\"background: transparent; color : white;\">\r\n"
				+ "        <h2>"+subname+"</h2>\r\n"
				+ "        <ul class=\"responsive-table\">\r\n"
				+ "          <li class=\"table-header\">\r\n"
				+ "            <div class=\"col col-1\">Quizz ID</div>\r\n"
				+ "            <div class=\"col col-3\">Results</div>\r\n"
				+ "          </li>");
		...
		for(int i=0; i<quizzes.size();i++) {
			out.print("<li class=\"table-row\">\r\n"
					...
					+ "            <div class=\"col col-3\" data-label=\"Marks\"><button class = \"attempt-btn\" name=\"attempt\" value=\""+quizzes.get(i)+"\">Show Results</button></div>\r\n"
					+ "            \r\n"
					+ "          </li>");
		}
