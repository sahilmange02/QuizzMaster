        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="faculty_home.jsp">Quizz</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="faculty_results_home.jsp">Results</a>
              </li>
          ...
          <form action="result_choose" method="post">
          <jsp:include page="result_choose" ></jsp:include>
