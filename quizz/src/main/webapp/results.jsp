...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body" data-bs-theme="dark">
      ...
      <ul class="tilesWrap">
        ...
        <form action="stud_result_home" method="post">
          <li>
            <h2>01</h2>
            <h3 style="font-size: 3rem;">Java</h3>
            <button name="subject" value="101">Show Results</button>
          </li>
          <li>
            <h2>02</h2>
            <h3 style="font-size: 3rem;">DBMS</h3>
            <button name="subject" value="303">Show Results</button>
          </li>
          <li>
            <h2>03</h2>
            <h3 style="font-size: 3rem;">DSA</h3>
            <button name="subject" value="202">Show Results</button>
          </li>
          </form>
          <!-- <li>
            <h2>04</h2>
