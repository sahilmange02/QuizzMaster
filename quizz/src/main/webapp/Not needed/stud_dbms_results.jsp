    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body" data-bs-theme="dark">
      ...
      <div class="container">
        ...
        <ul class="responsive-table">
          ...
          <li class="table-row">
            <div class="col col-1" data-label="Quizz ID">42235</div>
            <div class="col col-3" data-label="Marks">10</div>
          </li>
          <li class="table-row">
            <div class="col col-1" data-label="Quizz ID">42442</div>
            <div class="col col-3" data-label="Marks">10</div>
          </li>
          <li class="table-row">
            <div class="col col-1" data-label="Quizz ID">42257</div>
            <div class="col col-3" data-label="Marks">10</div>
          </li>
          <li class="table-row">
            <div class="col col-1" data-label="Quizz ID">42311</div>
            <div class="col col-3" data-label="Marks">10</div>
          </li>
          <li class="table-row">
            <div class="col col-1" data-label="Quizz ID">42311</div>
